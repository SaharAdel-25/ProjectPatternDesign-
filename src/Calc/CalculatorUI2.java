...
public final class CalculatorUI2 extends javax.swing.JFrame {
    // ==== Singleton (مثل ما عندك) ====
    private static CalculatorUI2 instance = null;
    ...
    public static CalculatorUI2 getInstance() {
        if (instance == null) {
            instance = new CalculatorUI2();
        }
        return instance;
    }
